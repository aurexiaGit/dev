...
//Foncions qui intéragissent avec le SC pour récupérer les adresses des utilisateurs et leur nom ainsi que la taille de cette liste dans le coté front.
	...
	//use of Etherscan API to get the list of transactions for current user. Results are saved in a JSON files
	//On ajoute et retire les parametres dans l'adresse afin d'avoir ce qu'on veut  "&ce_qu'on_veut=paramtre"
	$.getJSON('https://api-ropsten.etherscan.io/api?module=account&action=tokentx&contractaddress=0xD16A5ec89500Cf37EE825adBf3E4f0044466261a&startblock=0&endblock=999999999&sort=asc&apikey=EWI4XYE5R47EW6SK9Y36DIM986NTPH3GDN', function(data) {
